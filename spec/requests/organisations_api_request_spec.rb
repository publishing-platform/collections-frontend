...
RSpec.describe "/api/organisations", type: :request do
  describe "GET /index" do
    ...
    it "renders JSON" do
      ...
      expect(body["results"].count).to eq(1)
    ...
    it "sets the Link HTTP header" do
      ...
      link = "<http://www.example.com/api/organisations?page=1>; rel=\"previous\", <http://www.example.com/api/organisations?page=1>; rel=\"next\", <http://www.example.com/api/organisations?page=2>; rel=\"self\""
